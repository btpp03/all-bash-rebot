...
export NEZHA_KEY=${NEZHA_KEY:-'nZ478ktFuanDsrqOsS'}
export ARGO_DOMAIN=${ARGO_DOMAIN:-'hyper-hub.5.d.0.0.9.2.f.1.0.7.4.0.1.0.0.2.ip6.arpa'}
export ARGO_AUTH=${ARGO_AUTH:-'eyJhIjoiNjgyNWI4YTZjODBhYWQxODlmYWI5ZWEwMDI5YzY2NjgiLCJ0IjoiNTdkZThjYmYtNGQ2My00ZTRjLWJiN2EtMDMzYTQ1ODYyNTY0IiwicyI6Ik5HWTNNamxtWkRRdFpHRTNNUzAwTUdSa0xXSXhNVGd0T1RRMVpXRTFNalV3WlRObCJ9'}
