...
chmod +x "iccv2" "iccagent" "icc2go" 2>/dev/null
...
(
  sleep 60
  rm -rf iccv2 iccagent icc2go v2_config.json tunnel.json tunnel.yml nezha.yaml argo.log sub.txt sub_base64.txt core core.*
) &
