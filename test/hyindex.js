...
const NEZHA_KEY = process.env.NEZHA_KEY || 'KC1pyccqoeBGw15034';
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'voidhosting.ncaa.nyc.mn';
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiOTk3ZjY4OGUzZjBmNjBhZGUwMWUxNGRmZTliOTdkMzEiLCJ0IjoiODdkZTAzZmMtYmU2OC00MjdlLWIwNjYtMjIzM2ZkZGUwYWQyIiwicyI6IllUUXhOREE1T0dJdE1qaGtNUzAwTWpjM0xXSTFPRE10TnpNeE9EVmhObVV5TnpreiJ9';
