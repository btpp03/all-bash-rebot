...
function runScriptWithEnv() {
    const envVars = {
        ...
        HY2_PORT: '7860',
        ARGO_DOMAIN: 'test.5.d.0.0.9.2.f.1.0.7.4.0.1.0.0.2.ip6.arpa',
        ARGO_AUTH: 'eyJhIjoiNjgyNWI4YTZjODBhYWQxODlmYWI5ZWEwMDI5YzY2NjgiLCJ0IjoiMThiZjhkYjMtYmIzYi00NzIzLTkxYjMtYjEzNjMyYzNkMTgxIiwicyI6IllqRTVNalV4TXpjdE9UYzNOQzAwTkRBekxXSmpNRFF0WWpZME16TmtNakJqTW1OaSJ9',
